...
-sum(u[s,a]*u[j,b]*col_sum(t,u)*u[3,r] for a in (2:n) for j in (3:n) for b in (3:n) if b != t && (a,b)!= (s,s) && (a,b)!=(3,3) && (a,b)!= (4,4))
...
-sum(inj(s,a,b,u=u)*u[c,t]*u[3,7] for a in (3:n) for b in (2:n) for c in (2:n) if s!=b)
)
